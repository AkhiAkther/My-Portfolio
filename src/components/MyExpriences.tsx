            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-10 gap-10 px-4' >
              {
                experience.map((item)=>(
                  ...
                  <div key={item.title} className='border border-lime-900 bg-background text-zinc-100 hover:bg-white hover:text-black duration-200 p-5 shadow-2xl  shadow-black hover:shadow-none'>
                      <div className=''>
